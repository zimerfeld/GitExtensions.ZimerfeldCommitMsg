...
Se este plugin ajuda no seu fluxo com o GitExtensions, você pode apoiar a manutencao pelo botao **Sponsor** do GitHub no repositorio:

[Patrocinar @zimerfeld](https://github.com/sponsors/zimerfeld)

> O repositorio ja inclui `.github/FUNDING.yml`, entao o botao **Sponsor** passa a aparecer assim que o GitHub Sponsors estiver habilitado para `@zimerfeld`.
